...
namespace TomatoPHP\TomatoUserActivities\Loggers;
...
class RequestLogger implements LoggerInterface
{
    ...
    public function __construct()
    {
        ...
        if (config('tomato-user-activities.request.enabled') && $handlers = config('tomato-user-activities.request.handlers')) {
            if (count($handlers)) {
