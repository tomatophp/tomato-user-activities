...
namespace TomatoPHP\TomatoUserActivities\Test;

use TomatoPHP\TomatoUserActivities\AdvancedLoggerServiceProvider;
use Carbon\Carbon;
...
abstract class TestCase extends Orchestra
{
    ...
    protected function getEnvironmentSetUp($app): void
    {
        ...
        $app['config']->set('tomato-user-activities.request.file', $this->getFixturesDirectory('request.log'));
        $app['config']->set('tomato-user-activities.request.excluded-paths', ['excluded']);
